...
export const TEST_ENV = { SITE_URL: TEST_SITE } as unknown as Env;

/** Maps an upstream URL path to a fixture file + content type. */
function fixtureFor(path: string): { file: string; type: string } | null {
