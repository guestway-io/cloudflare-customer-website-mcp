/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 22c761bb3e2ed7e39c3e7d8b9d149251)
// Runtime types generated with workerd@1.20260603.1 2025-05-01 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	SITE_URL: "https://guestway.io";
	DOCS_URL: "https://docs.guestway.io";
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").GuestwayMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GuestwayMCP";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "DOCS_URL">> {}
}
